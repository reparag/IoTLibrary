...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Parag Patil" => "parag.p@refurbedge.com" }
  # Or just: spec.author    = "Parag Patil"
  # spec.authors            = { "Parag Patil" => "parag.p@refurbedge.com" }
  # spec.social_media_url   = "https://twitter.com/Parag Patil"
  ...
  spec.swift_versions = ['5.0', '5.1', '5.2', '5.3', '5.4', '5.5', '5.6', '5.7', '5.8', '5.9', '5.10', '6.0', '6.1']
